...
obj.row=parseInt(obj.row);
let linechart={};
linechart.data=$scope[obj.arrData];
linechart.size={};
...
linechart.itemWidth=linechart.size.x/obj.row;
linechart.originPosition={};
linechart.originPosition.x=parseInt($(el).find('[id^="hzZXT"]').attr('x1'));
linechart.originPosition.y=parseInt($(el).find('[id^="hzZXT"]').attr('y1'));
$(el).find('[id^="hzfgxZXT"]').html('');
$(el).find('[id^="zzzbZXT"]').html('');
$(el).find('[id^="zzfgxZXT"]').html('');
$(el).find('[id^="mainLineZXT"]').html('');
$(el).find('[id^="mainPointZXT"]').html('');
$(el).find('[id^="itemListZXT"]').html('');
$(el).find('[id^="hzzbZXT"]').html('');
...
}else if(obj.widget_type=='tableList'){
let tableList={};
tableList.size={};
...
}else if(obj.pipedirect=='longitudinal'){
